...
```
sudo ln -s ~/software/freebayes/bin/freebayes /usr/local/bin/
freebayes --help
```
...
$BCFTOOLS13 filter -O z -o Ecoli_DH10B-rmdup-filtered.vcf.gz -i'%QUAL>10' Ecoli_DH10B-rmdup.vcf.gz
vt peek Ecoli_DH10B-rmdup.vcf.gz
```
